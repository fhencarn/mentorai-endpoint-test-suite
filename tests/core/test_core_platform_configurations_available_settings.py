...
def test_core_platform_configurations_available_settings():
    endpoint = "/api/core/platform/configurations/available-settings/"
...
if __name__ == "__main__":
    test_core_platform_configurations_available_settings()