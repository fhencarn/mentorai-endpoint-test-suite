...
def test_list_periodic_agents():
    url = f"{BASE_URL}/api/ai-mentor/orgs/{ORG}/users/{USER_ID}/periodic-agents/"
    ...
    print("\n" + "=" * 90)
    print("TEST: List Periodic Agents")
    print("=" * 90)
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(
                f"| ai-mentor | /api/ai-mentor/orgs/{{org}}/users/{{user_id}}/periodic-agents/ | "
                f"GET | ibl.ai docs | 200 | working | "
                f"Returned periodic agent list (count={count}) | "
                f"Validated list endpoint; paginated structure confirmed. |"
            )
            ...
            print(
                ...
                f"Access denied | Endpoint likely restricted to admins. |"
            )
            ...
            print(
                ...
                f"Not found | Verify org/user_id. |"
            )
