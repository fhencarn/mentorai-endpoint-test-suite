...
def test_get_usage():
    url = f"{BASE_URL}/api/ai-mentor/orgs/{ORG}/users/{USER_ID}/usage/"
    ...
    try:
        ...
        if response.status_code == 200:
            print(
                "| ai-mentor | /api/ai-mentor/orgs/{org}/users/{user_id}/usage/ | "
                "GET | ibl.ai docs | 200 | working | "
                "Usage data retrieved | Endpoint returned tenant or user usage summary successfully. |"
            )
            ...
            print(
                f"| ai-mentor | /api/ai-mentor/orgs/{{org}}/users/{{user_id}}/usage/ | "
