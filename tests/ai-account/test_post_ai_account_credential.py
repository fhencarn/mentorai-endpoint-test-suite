...
# Use a safe test name so you do not overwrite real credentials
...
def test_post_ai_account_credential():
    ...
    if response.status_code in [200, 201]:
        label = "working"
        summary = "LLM credential created"
        notes = "Auth successful; created tenant LLM credential."
...
if __name__ == "__main__":
    test_post_ai_account_credential()