...
MESSAGE = "Tenant is now using the default LLM key."


def test_post_ai_account_use_default_llm_key():
    endpoint_template = "/api/ai-account/orgs/{org}/use-default-llm-key/"
    ...
    if response.status_code == 200:
        label = "working"
        summary = "Default LLM key usage updated"
        notes = "Auth successful; tenant default LLM key usage was updated."
...
if __name__ == "__main__":
    test_post_ai_account_use_default_llm_key()