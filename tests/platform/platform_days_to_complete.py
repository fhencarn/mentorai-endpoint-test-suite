...
# Build request (no response body expected on 200)
url     = f"https://base.manager.ai.syr.edu/api/platform/orgs/{org_id}/courses/{course_id}/users/{user_id}/progress/days-to-complete"
